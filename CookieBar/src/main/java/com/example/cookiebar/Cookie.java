...
//        cookieId = ++cookieCounter;
    ...
    private void validateLayoutIntegrity() {
        if (layoutCookie == null || titleTextView == null ||
                iconImageView == null) {
...
//        @SuppressLint("ResourceType") int backgroundColor = ThemeResolver.getColor(context, R.attr.cookieBackgroundColor, ContextCompat.getColor(context, Color.TRANSPARENT));
